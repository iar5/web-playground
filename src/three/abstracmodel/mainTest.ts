...
function init() {
    ...
    // https://github.com/mrdoob/three.js/tree/master/examples/textures/equirectangular/
    new RGBELoader().setPath('/img/360/').load( 'quarry_01_1k.hdr', function ( texture ) {
...
function animation( msTime ) {
    ...
    console.log(cubeRenderTarget.texture.image); // TODO warum ist die leer? bug? version udpaten?
